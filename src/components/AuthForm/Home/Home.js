...
import trackImage from "E:/Final-year-pro/AI-Powered-Dermatological-Diagnosis-and-Consultancy-Project/src/assets/images/Track.jpg";
import recoImage from "E:/Final-year-pro/AI-Powered-Dermatological-Diagnosis-and-Consultancy-Project/src/assets/images/Reco.jpg";
import virImage from "E:/Final-year-pro/AI-Powered-Dermatological-Diagnosis-and-Consultancy-Project/src/assets/images/vir.jpg";
...
const Home = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    navigate('/docreco'); // redirect to /a page
  };
  ...
  return (
    <div className="home-container">
      ...
      <section className="Consult">
        ...
        {/* Working Form */}
        <form className="Expert_Consutant" onSubmit={handleSubmit}>
          <input
            type="text"
